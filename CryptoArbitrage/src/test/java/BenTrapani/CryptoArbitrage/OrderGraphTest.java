...
public class OrderGraphTest {
	...
	public void testGraphEdge() {
		...
		GraphEdge graphEdge = new OrderGraph.GraphEdge("poloniex", Currency.BTC, true, new BigDecimal(1.0), new BigDecimal(1000.0), fee);
		...
		GraphEdge graphEdgeDup = new OrderGraph.GraphEdge("poloniex", Currency.BTC, true, new BigDecimal(1.0), new BigDecimal(1000.0), fee);
	    assertTrue(testEdgeSet.contains(graphEdgeDup));
	    
	    GraphEdge graphEdgeNot1 = new OrderGraph.GraphEdge("poloniexx", Currency.BTC, true, new BigDecimal(1.0), new BigDecimal(1000.0), fee);
	    ...
	    GraphEdge graphEdgeNot3 = new OrderGraph.GraphEdge("poloniex", Currency.BTC, false, new BigDecimal(1.0), new BigDecimal(1000.0), 
	    		new BigDecimal(0.0025));
	    GraphEdge graphEdgeNot4 = new OrderGraph.GraphEdge("poloniex", Currency.BTC, true, new BigDecimal(2.0), new BigDecimal(1000.0), fee);
	    GraphEdge graphEdgeNot5 = new OrderGraph.GraphEdge("poloniex", Currency.BTC, true, new BigDecimal(1.0), new BigDecimal(1001.0), fee);
	    GraphEdge graphEdgeNot6 = new OrderGraph.GraphEdge("poloniex", Currency.BTC, true, new BigDecimal(1.0), new BigDecimal(1000.0), 
	    		fee.add(new BigDecimal(0.1)));
	    ...
	    assertEquals(new BigDecimal(0.9975).divide(new BigDecimal(1000), 7, BigDecimal.ROUND_HALF_UP), 
	    		graphEdgeNot2.ratio.setScale(7, BigDecimal.ROUND_HALF_UP));
	    assertEquals(new BigDecimal(997.5).setScale(1, BigDecimal.ROUND_HALF_UP), 
	    		graphEdgeNot3.ratio.setScale(1, BigDecimal.ROUND_HALF_UP));
	}
	...
	public void testTwoSidedGraphEdge() {
		TwoSidedGraphEdge e1 = new TwoSidedGraphEdge(Currency.USD, new GraphEdge("exch1", Currency.DGC, true, 
				new BigDecimal(0.5), new BigDecimal(1.0), new BigDecimal(0.0025)));
	...
	public void testAddAndRemoveEdge() {
		...
		graph.addEdge(Currency.USD, Currency.BTC, "poloniex", 
				true, new BigDecimal(2), new BigDecimal(1500), fee);
		...
		TwoSidedGraphEdge e1 = new TwoSidedGraphEdge(Currency.USD, new GraphEdge("poloniex", Currency.BTC, true, new BigDecimal(2), 
				new BigDecimal(1500), fee));
		TwoSidedGraphEdge e2 = new TwoSidedGraphEdge(Currency.USD, new GraphEdge("bitmex", Currency.BTC, true, new BigDecimal(4), 
				new BigDecimal(750), fee));

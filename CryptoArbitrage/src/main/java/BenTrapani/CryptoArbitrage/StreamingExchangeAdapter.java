 ...
 *
 *         Implements a limited subset of the functionality of a streaming
 *         exchange. It implements only the functionality required by the
 *         OrderBookAnalyzer and Aggregator.
 * 
 */
